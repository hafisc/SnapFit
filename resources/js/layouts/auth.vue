<template>
  <div class="min-h-screen flex items-center justify-center p-4 md:p-10 bg-[#FAFAFA] font-sans selection:bg-orange-100">
    ...
    <div class="w-full max-w-6xl flex flex-col md:flex-row bg-white rounded-[3.5rem] overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.06)] border border-white relative">
      ...
      <div class="w-full md:w-[45%] bg-slate-900 p-10 md:p-16 flex flex-col justify-between relative overflow-hidden min-h-[400px] md:min-h-0">
        ...
        <div class="relative z-10">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-3 text-slate-400">
              ...
              <p class="text-xs font-bold uppercase tracking-widest">AI-Powered Studio</p>
            </div>
            <div class="flex items-center gap-3 text-slate-400">
              ...
              <p class="text-xs font-bold uppercase tracking-widest">Real-time Co-Creation</p>
            </div>
          </div>
        </div>
        ...
        <div class="relative z-10 mt-20 md:mt-0 pt-10 border-t border-white/5">
          <div class="flex flex-col gap-6">
            <p class="text-[9px] uppercase tracking-[0.4em] text-slate-500 font-black">Trusted by Malang Creative Lab</p>
      ...
      <div class="w-full md:w-[55%] p-8 md:p-20 bg-white flex items-center relative">
        <div class="max-w-md mx-auto w-full">
          <div class="mb-12">
            ...
            <p class="text-slate-400 text-sm font-medium leading-relaxed">
              {{ isLogin ? 'Akses dashboard Anda dan mulai berkolaborasi hari ini.' : 'Daftarkan diri Anda sebagai bagian dari ekosistem kreatif Malang.' }}
            </p>
          </div>
          ...
          <form class="space-y-6" @submit.prevent="submit">
              ...
              <div v-if="!isLogin">
                ...
                <div class="relative group">
                  ...
                  <input v-model="name" type="text" placeholder="John Doe" 
                    class="w-full bg-slate-50 border border-slate-100 rounded-[1.25rem] pl-14 pr-6 py-4.5 outline-none focus:ring-[6px] focus:ring-orange-500/5 focus:border-orange-500 focus:bg-white transition-all text-slate-900 font-semibold" />
                </div>
              </div>
            </transition>
            ...
            <div>
              <div class="flex justify-between mb-3 ml-1">
                ...
                <button v-if="isLogin" type="button" class="text-[9px] font-black uppercase tracking-widest text-orange-600 hover:text-orange-700 underline underline-offset-4 decoration-orange-200">Forgot Password?</button>
              </div>
              <div class="relative group">
                <span class="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-orange-500 transition-colors">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 00-2 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                </span>
            ...
            <button :disabled="loading" type="submit"
              ...
              <span class="relative z-10" v-if="loading">Processing System...</span>
              <span class="relative z-10" v-else>{{ isLogin ? 'Access Account' : 'Initialize Profile' }}</span>
            </button>
...
const submit = async () => {
  ...
  try {
    ...
    if (!res.ok) {
      ...
      // Trigger simple shake animation or alert here if needed
...
/* Custom padding for professional input look */
.py-4\.5 {
