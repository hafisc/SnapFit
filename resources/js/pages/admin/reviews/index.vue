          ...
          <tbody class="divide-y divide-slate-50">
            ...
            <tr v-else v-for="review in reviews" :key="review.id" class="hover:bg-slate-50/50 transition-colors group">
              ...
              <td class="px-6 py-4 text-right">
                <button @click="deleteReview(review.id)" class="w-8 h-8 rounded-lg bg-red-50 text-red-600 flex items-center justify-center hover:bg-red-100 transition-colors inline-flex opacity-100">
