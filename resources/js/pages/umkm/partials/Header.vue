  ...
  <header class="h-16 sm:h-[72px] bg-white border-b border-slate-200/60 sticky top-0 z-20 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
    <div class="flex items-center gap-3 sm:gap-4 min-w-0">
      ...
      <button
        ...
        class="lg:hidden w-9 h-9 rounded-lg bg-slate-100 flex items-center justify-center text-slate-500 flex-shrink-0"
      >
      ...
      <div class="min-w-0">
        <h1 class="text-sm sm:text-[15px] font-bold text-slate-800 truncate">{{ pageTitle }}</h1>
    ...
    <div class="flex items-center gap-2">
      ...
      <div class="hidden md:flex items-center bg-slate-50 rounded-lg px-3.5 py-2 gap-2 border border-slate-100">
        ...
        <input
          ...
          class="bg-transparent outline-none text-[12px] font-medium text-slate-600 w-40 placeholder:text-slate-400"
        />
      </div>
